...
from backend.app.baseline_engine import get_baseline, update_baseline_for_entity
from backend.app.scoring_engine import calculate_risk_score
from backend.app import models

app = FastAPI(title="Campus IDS Anomaly Detection Backend", version="1.0")

# Enable CORS for Vite Frontend (Port 5173) and local development
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5173",
